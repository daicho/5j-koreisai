        ...
        if (regist) {
          ...
          if (regist) {
            ...
            if (res == null) {
              ...
              if (res != null)
                ranking = PApplet.parseInt(res[0][0]);
            }
...
public class Title implements Scene {
  ...
  public Title() {
    ...
    highScore = PApplet.parseInt(ranking[0][1]);
  }
  ...
  public void draw() {
    ...
    text("なまえ", SCREEN_SIZE.x * 0.45f, 403);
    text("スコア", SCREEN_SIZE.x * 0.8f, 403);
    fill(0);
    rect(SCREEN_SIZE.x / 2, 417.5f, SCREEN_SIZE.x * 0.85f, 1);
    textFont(font2, 26);
    for (int i = 0; i < 10; i++) {
      text(i + 1, SCREEN_SIZE.x * 0.15f, 433 + i * 30);
      text(ranking[i][0], SCREEN_SIZE.x * 0.45f, 433 + i * 30);
      text(ranking[i][1], SCREEN_SIZE.x * 0.8f, 433 + i * 30);
      rect(SCREEN_SIZE.x / 2, 447.5f + i * 30, SCREEN_SIZE.x * 0.85f, 1);
    }
